...
import GroupTimetable.calendar.database.Database;
...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        createEventButton.addActionListener(evt -> onCreateEventPerformed(evt));
        jPanel1.add(createEventButton, new AbsoluteConstraints(790, 10, 130, 30));
        ...
        jPanel1.add(jLabel1, new AbsoluteConstraints(10, 10, 180, -1));
        ...
        jPanel1.add(jLabel2, new AbsoluteConstraints(160, 10, 170, -1));
        ...
        jPanel1.add(jScrollPane1, new AbsoluteConstraints(2, 94, 920, 540));
        ...
        jPanel1.add(jLabel4, new AbsoluteConstraints(20, 70, -1, -1));
    ...
    private void onCreateEventPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
                    ...
                    if (newEvent.eventDate.compareTo(datePicker1.getDate().toString()) >= 0) {
                        ...
                        if (newEvent.eventType.equals("personal")) {
                            ...
                            if (newEvent.weeksToRepeat == 0) {
                                ...
                                Event newEvt = new Event(db.getEventCount(), dateString, newEvent.eventHourTime, newEvent.eventName, personName);
                                db.addEventToDatabse(newEvt, db.getEventCount());
                            } else {
                            ...
                            for (int i = 0; i < newEvent.weeksToRepeat; i++) {
                                dateString = localDate.plusWeeks(i).format(formatter);
                                Event newEvt = new Event(db.getEventCount(), dateString, newEvent.eventHourTime, newEvent.eventName, newEvent.eventType);
                                db.addEventToDatabse(newEvt, db.getEventCount());
                            }
                        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (col == 2) {
            ...
            if (dialogResult == JOptionPane.YES_OPTION) {
                ...
                int value = (int)jTable1.getModel().getValueAt(row, 3);
                db.removeEventFromDatabase(value);
        ...
        newPerson.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent windowEvent) {
                if (newPerson.personName != null && newPerson.personSurname != null && newPerson.facultyName != null && (newPerson.yearOfStudies > 0 && newPerson.yearOfStudies < 5)) {
                    ...
                    if (newPerson.personType.equals("MIFSAStudent")) {
    ...
    public void getTimetable(String date, String personListItem) {
        ...
        //We can re-use a getEvents method in the calendar.databse.Database class, and retrieve any events with a second string as a filter
