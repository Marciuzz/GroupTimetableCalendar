...
public class NewPersonJFrame extends javax.swing.JFrame implements Serializable{
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        personType = Objects.requireNonNull(jComboBox1.getSelectedItem()).toString();
        ...
        if (!jTextField4.getText().isEmpty() && !(personType.equals("Teacher"))) {
